...
function PinMap({ user, pins, groups, getMyPins, pinsEditable, selectedPin, setSelectedPin, titleDisplay, editGroup, selectedGroup }) {
    ...
    return(
        <>
            ...
            <ReactMapGL {...viewState} mapboxAccessToken={process.env.REACT_APP_MAPBOX_TOKEN} onMove={evt => setViewState(evt.viewState)} style={{width: "calc(100vw - 235px", height: "calc(100vh - 129px"}} mapStyle="mapbox://styles/glpierce174/cl0h3s1v8004t15m6qw98t5oj">
